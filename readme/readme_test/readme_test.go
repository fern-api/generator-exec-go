...
func TestReadmeGenerateReadmeWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/api/readme/{taskId}")).WithPathParam(
		"taskId",
	...
	invocationErr := client.Readme.GenerateReadme(
		context.TODO(),
		"taskId",
		request,
	)
